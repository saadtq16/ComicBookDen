			...
			<?php
				...
				if($check < 1){
					...
					while($row = mysqli_fetch_assoc($result)){
						if(($count % 6) != 0){
							echo "<td><div class ='unit' id='".$row['movie_name']."'><div class='pic'><img src='data:image/jpeg;base64,".base64_encode($row['image'])."'</div><br><center>Issue: ".$row['movie_name']."<br>Release date: ".$row['release_date']."<br>Ratings: ".$row['imdb']."</center></div></td>";
							$count++;
						}
						else{
							echo "</tr><tr><td><div class ='unit' id='".$row['movie_name']."'><div class='pic'><img src='data:image/jpeg;base64,".base64_encode($row['image'])."'</div><br><center>Issue: ".$row['movie_name']."<br>Release date: ".$row['release_date']."<br>Ratings: ".$row['imdb']."</center></div></td>";
							$count++;
						}
					}
					echo "</tr>";
